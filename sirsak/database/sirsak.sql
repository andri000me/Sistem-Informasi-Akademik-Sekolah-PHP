...
--
-- Host: localhost
-- Generation Time: Mar 28, 2015 at 01:41 AM
...
(1, 'Andi Sholihin', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2015-03-28 01:40:46', '2015-03-28 01:22:24', '', '', '', '', '', NULL),
...
('1', 'Hasan Sulthoni', 'hasan', 'fc3f318fba8b3c1502bece62a27712df', '');
...
ALTER TABLE `administrator`
 ADD PRIMARY KEY (`idAdministrator`,`T_U_idT_U`,`Guru_idGuru`,`Siswa_idSiswa`,`Wali_kelas_idWali_kelas`,`Wali_murid_idWali_murid`), ADD UNIQUE KEY `username` (`username`), ADD KEY `fk_Administrator_T_U` (`T_U_idT_U`), ADD KEY `fk_Administrator_Guru` (`Guru_idGuru`), ADD KEY `fk_Administrator_Siswa` (`Siswa_idSiswa`), ADD KEY `fk_Administrator_Wali_kelas` (`Wali_kelas_idWali_kelas`), ADD KEY `fk_Administrator_Wali_murid` (`Wali_murid_idWali_murid`), ADD KEY `fk_Administrator_Kep_sek` (`Kep_sek_idKep_sek`);

--
-- Indexes for table `guru`
--
ALTER TABLE `guru`
 ADD PRIMARY KEY (`idGuru`), ADD KEY `fk_Guru_Wali_kelas` (`Wali_kelas_idWali_kelas`);

--
-- Indexes for table `guru_has_mata_pelajaran`
--
ALTER TABLE `guru_has_mata_pelajaran`
 ADD PRIMARY KEY (`idGuru`,`idmata_pelajaran`,`idRuang_Kelas`), ADD KEY `fk_Guru_has_mata_pelajaran_Guru` (`idGuru`), ADD KEY `fk_Guru_has_mata_pelajaran_mata_pelajaran` (`idmata_pelajaran`), ADD KEY `fk_Guru_has_mata_pelajaran_ruang_kelas` (`idRuang_Kelas`);

--
-- Indexes for table `kep_sek`
--
ALTER TABLE `kep_sek`
 ADD PRIMARY KEY (`idKep_sek`,`T_U_idT_U`), ADD KEY `fk_Kep_sek_T_U` (`T_U_idT_U`);
...
ALTER TABLE `mata_pelajaran_has_ruang_kelas`
 ADD PRIMARY KEY (`idmata_pelajaran`,`idRuang_Kelas`,`hari`), ADD KEY `fk_mata_pelajaran_has_Ruang_Kelas_mata_pelajaran` (`idmata_pelajaran`), ADD KEY `fk_mata_pelajaran_has_Ruang_Kelas_Ruang_Kelas` (`idRuang_Kelas`);

--
-- Indexes for table `ruang_kelas`
--
ALTER TABLE `ruang_kelas`
 ADD PRIMARY KEY (`idRuang_Kelas`), ADD UNIQUE KEY `nama` (`nama`);
...
ALTER TABLE `siswa_has_mata_pelajaran`
 ADD PRIMARY KEY (`idSiswa`,`idmata_pelajaran`,`semester`,`thn_ajaran`), ADD KEY `fk_Siswa_has_mata_pelajaran_Siswa` (`idSiswa`), ADD KEY `fk_Siswa_has_mata_pelajaran_mata_pelajaran` (`idmata_pelajaran`);
...
ALTER TABLE `t_u_has_guru`
 ADD PRIMARY KEY (`T_U_idT_U`,`Guru_idGuru`), ADD KEY `fk_T_U_has_Guru_T_U` (`T_U_idT_U`), ADD KEY `fk_T_U_has_Guru_Guru` (`Guru_idGuru`);

--
-- Indexes for table `t_u_has_mata_pelajaran`
--
ALTER TABLE `t_u_has_mata_pelajaran`
 ADD PRIMARY KEY (`T_U_idT_U`,`mata_pelajaran_idmata_pelajaran`), ADD KEY `fk_T_U_has_mata_pelajaran_T_U` (`T_U_idT_U`), ADD KEY `fk_T_U_has_mata_pelajaran_mata_pelajaran` (`mata_pelajaran_idmata_pelajaran`);

--
-- Indexes for table `t_u_has_ruang_kelas`
--
ALTER TABLE `t_u_has_ruang_kelas`
 ADD PRIMARY KEY (`T_U_idT_U`,`Ruang_Kelas_idRuang_Kelas`), ADD KEY `fk_T_U_has_Ruang_Kelas_T_U` (`T_U_idT_U`), ADD KEY `fk_T_U_has_Ruang_Kelas_Ruang_Kelas` (`Ruang_Kelas_idRuang_Kelas`);

--
-- Indexes for table `t_u_has_wali_murid`
--
ALTER TABLE `t_u_has_wali_murid`
 ADD PRIMARY KEY (`T_U_idT_U`,`Wali_murid_idWali_murid`), ADD KEY `fk_T_U_has_Wali_murid_T_U` (`T_U_idT_U`), ADD KEY `fk_T_U_has_Wali_murid_Wali_murid` (`Wali_murid_idWali_murid`);
...
ALTER TABLE `wali_murid_has_siswa`
 ADD PRIMARY KEY (`idwali_murid`,`idSiswa`), ADD KEY `fk_wali_murid_has_siswa_wali_murid` (`idwali_murid`), ADD KEY `fk_wali_murid_has_siswa_siswa` (`idSiswa`);
